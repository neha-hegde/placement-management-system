...
public class Home extends JFrame implements ActionListener
{
	...
	Home()
	{
		...
		welcome.setBounds(520,100, 400,150);
		con.add(welcome);
		...
		insert.setBounds(350,275,175, 50);
		...
		delete.setBounds(650,275, 100, 50);
		Font font2 = new Font("Verdana", Font.BOLD, 16);
        delete.setFont(font2);
        delete.setForeground(Color.BLACK);
        delete.setBackground(Color.LIGHT_GRAY);

		display = new JButton("Delete Record");
		display.addActionListener(this);
		display.setBounds(870,275, 160, 50);
